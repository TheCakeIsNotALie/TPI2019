...
namespace TimeBeam.Events {
  ...
  public class SelectionChangedEventArgs : EventArgs {
    ...
    /// </summary>
    public IEnumerable<IKeyFrame> Selected { get; private set; }

    /// <summary>
    ///   The track elements that were deselected in the operation.
    /// </summary>
    public IEnumerable<IKeyFrame> Deselected { get; private set; }
    ...
    public SelectionChangedEventArgs( IEnumerable<IKeyFrame> selected, IEnumerable<IKeyFrame> deselected ) {
      Selected = selected;
